	...
	<table border="1">
		...
		<c:forEach var="productDTO" items="${productList }">
			<tr>
				...
				<td><fmt:formatNumber value="${productDTO.price }"></fmt:formatNumber></td>
				<td><fmt:formatNumber value="${prodcutDTO.deliveryPrice }"></fmt:formatNumber></td>
				<td><fmt:formatNumber value="${prodcutDTO.enrollDt }" pattern="yyyy-MM-dd"></fmt:formatNumber></td>
